...
class IsolationForestTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->estimator = new IsolationForest(500, 0.7, 0.5);
    }
    ...
    public function test_make_prediction()
    {
        ...
        $probabilties = $this->estimator->proba($this->testing);

        $this->assertGreaterThan(0.50, $probabilties[0]);
        $this->assertGreaterThan(0.50, $probabilties[1]);
        $this->assertLessThanOrEqual(0.50, $probabilties[2]);
