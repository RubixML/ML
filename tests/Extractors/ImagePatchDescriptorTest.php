...
class ImagePatchDescriptorTest extends TestCase
{
    ...
    public function test_extract_samples()
    {
        ...
        $this->assertEquals([
            [49.5625, 267.42664930555566, 0.015499269852335452, -0.7975132983112356,
            57.22916666666667, 465.3849826388888, 0.30196579288329717, -1.0110518843270149,
            61.77083333333333, 223.24609374999997, 0.02558963587626202, -0.9761468969499858,
            32.666666666666664, 184.5, 0.35870571583199723, -1.2421806211437605],
        ], $samples);
    }
}
