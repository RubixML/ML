...
class MulticlassTest extends TestCase
{
    ...
    public function test_forward_back_infer()
    {
        ...
        $expected = [
            [0.3612946134176707, 0.6241343476025714, 0.30971384304726435],
            [0.3385303477874471, 0.37111550276063865, 0.05173667658713666],
            [0.30017503879488217, 0.004750149636789916, 0.638549480365599],
        ];
