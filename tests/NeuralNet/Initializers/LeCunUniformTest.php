...
use Rubix\ML\NeuralNet\Initializers\LeCunUniform;
...
final class LeCunUniformTest extends TestCase
{
    ...
    {
        //given
        $w = (new LeCunUniform())->initialize(fanIn: $fanIn, fanOut: $fanOut, dataType: 'float32');
    ...
    public function exceptionThrownForInvalidFanValues(int $fanIn, int $fanOut) : void
    {
        ...
        //when
        (new LeCunUniform())->initialize(fanIn: $fanIn, fanOut: $fanOut, dataType: 'float32');
    }
