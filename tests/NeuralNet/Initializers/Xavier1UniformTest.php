...
final class Xavier1UniformTest extends TestCase
{
    ...
    {
        //given
        $w = (new Xavier1Uniform())->initialize(fanIn: $fanIn, fanOut: $fanOut, dataType: 'float32');
    ...
    public function distributionStatisticsMatchXavier1Uniform(int $fanIn, int $fanOut) : void
    {
        //given
    ...
    public function exceptionThrownForInvalidFanValues(int $fanIn, int $fanOut) : void
    {
        ...
        //when
        (new Xavier1Uniform())->initialize(fanIn: $fanIn, fanOut: $fanOut, dataType: 'float32');
    }
