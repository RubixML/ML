...
/**
 * @group Clusterers
 * @covers \Rubix\ML\Clusterers\KMedoids
 */
class KMedoidsTest extends TestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->estimator = new KMedoids(3, 128, 300, 1e-4, 5, new Euclidean(), new PlusPlus());
    ...
    {
        $this->assertInstanceOf(KMedoids::class, $this->estimator);
    ...
    public function trainPartialPredict() : void
    {
        ...
        $this->assertContainsOnly('array', $medoids);
