...
class GaussianMixture implements Estimator, Learner, Probabilistic, Verbose, Persistable
{
    ...
    /**
     * The amount of epsilon smoothing added to the variance of each cluster.
     *
     * @var float
     */
    ...
    /**
     * Initialize the gaussian components by calculating the means and variances of k initial
     * cluster centroids generated by the seeder.
     *
     * @param Dataset $dataset
     */
