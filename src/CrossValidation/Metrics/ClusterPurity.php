 ...
 * Cluster Purity
 *
 * A ground-truth clustering metric that measures the mean ratio of samples in a cluster
 * that are also members of the cluster's dominant class. A cluster is said to be *pure*
 * when the entire cluster is comprised of a single class of samples.
 *
 * Note: This metric computes a purity score, not the conditional entropy-based
 * homogeneity measure defined by Rosenberg et al. (2007).
 *
 * @category    Machine Learning
 * @package     Rubix/ML
 * @author      Andrew DalPino
 */
class ClusterPurity implements Metric
{
    /**
