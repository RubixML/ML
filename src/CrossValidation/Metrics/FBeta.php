 ...
 * F Beta
 *
 * A weighted harmonic mean of precision and recall. The beta parameter
 * controls the weight of precision in the combined score. As beta goes to
 * infinity the score only considers recall whereas when it goes to 0 it
 * only considers precision.
 *
