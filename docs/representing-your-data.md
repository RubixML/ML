...
**Note:** You can easily convert between features of various types by applying transformer such as [One Hot Encoder](transformers/one-hot-encoder.md) or [Interval Discretizer](transformers/interval-discretizer.md) to a dataset.
