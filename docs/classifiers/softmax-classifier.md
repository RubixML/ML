...
# Softmax Classifier
A generalization of [Logistic Regression](logistic-regression.md) for the multiclass case using a single layer neural network with a [Softmax](../neural-network/activation-functions/softmax.md) output layer.
