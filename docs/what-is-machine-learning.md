...
Machine learning (ML) is a form of programming that uses data to *train* a learner to make predictions (referred to as *inference*) about unknown or future outcomes. Unlike traditional programming in which rules are explicitly programmed, machine learning uses data to induce rulesets automatically. The field of Machine learning is further broken down into subcategories based on the problems they aim to solve.
